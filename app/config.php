...
return [
    //公众号
    'weixin'=>['appID'=>'wx858ef6b7d842c007','appsecret'=>'a767560a950671d28c640ccc27f3d6f7'],
    ...
    //用户类型
    'memberGroup' => array(         
        array('id'=>1,'name'=>'普通用户'),
        array('id'=>2,'name'=>'会员用户')
    ),
    ...
    */
    'baoguoType' => array(         
        ...
        array('id'=>4,'name'=>'保健品','max'=>8,'same'=>6,'can'=>[6,7,8,9,10]),
        array('id'=>6,'name'=>'30元以上','max'=>1,'same'=>1,'can'=>[4,7,8,10]),
        array('id'=>7,'name'=>'15-30元','max'=>2,'same'=>2,'can'=>[4,6,8,9,10]),
        array('id'=>8,'name'=>'15元以下','max'=>4,'same'=>4,'can'=>[4,6,7,9,10]),
        array('id'=>9,'name'=>'15++蜂蜜','max'=>2,'same'=>1,'can'=>[4,8,10]),
        array('id'=>10,'name'=>'日用品','max'=>6,'same'=>6,'can'=>[4,6,7,8,9,10]),

        //array('id'=>11,'name'=>'特殊商品(4个可混)','max'=>4,'same'=>4,'can'=>[4]),
