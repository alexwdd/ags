...
return [
    ...
    */
    'baoguoType' => array(         
        ...
        array('id'=>4,'name'=>'保健品','max'=>8,'same'=>6,'can'=>[8,9,10,11]),
        array('id'=>5,'name'=>'鞋子','max'=>1,'same'=>99,'can'=>[]),

        array('id'=>6,'name'=>'特殊商品(1个不混)','max'=>1,'same'=>1,'can'=>[]),
        array('id'=>7,'name'=>'特殊商品(2个不混)','max'=>2,'same'=>2,'can'=>[]),

        array('id'=>8,'name'=>'特殊商品(1个可混)','max'=>1,'same'=>1,'can'=>[4]),
        array('id'=>9,'name'=>'特殊商品(2个可混)','max'=>2,'same'=>2,'can'=>[4]),
        array('id'=>10,'name'=>'特殊商品(3个可混)','max'=>3,'same'=>3,'can'=>[4]),
